...
public class AuthController {
    ...
    @PostMapping("/kakao")
    @Operation(summary = "카카오 로그인", description = "인기코드로 akako 사용자 정보 확인" + "-> accessToken, refreshToken 발급")
    ...
    public ApiResponse<Void> withdraw(
            @AuthenticationPrincipal Jwt jwt,
            HttpServletResponse httpRespones
    ) {
        httpRespones.addHeader(
                HttpHeaders.SET_COOKIE,
                deleteRefreshTokenCookie().toString()
        );
