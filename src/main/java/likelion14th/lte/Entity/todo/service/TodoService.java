package likelion14th.lte.Entity.todo.service;

import jakarta.transaction.Transactional;
import likelion14th.lte.Entity.category.entity.Category;
import likelion14th.lte.Entity.category.repository.CategoryRepository;
import likelion14th.lte.Entity.todo.dto.request.TodoCreateRequest;
import likelion14th.lte.Entity.todo.dto.request.TodoUpdateRequest;
import likelion14th.lte.Entity.todo.dto.response.TodoDetailResponse;
import likelion14th.lte.Entity.todo.dto.response.TodoListResponse;
import likelion14th.lte.Entity.todo.entity.Todo;
import likelion14th.lte.Entity.todo.entity.TodoDate;
import likelion14th.lte.Entity.todo.entity.WeekEnum;
...
public class TodoService {
    ...
    public TodoListResponse todoComplete(Long userId, Long todoId, LocalDate date, boolean completed) {
        ...
        if (todoDate.isCompleted() != completed) {
            todoDate.setCompleted(completed, completed ? LocalDateTime.now() : null);
        }
